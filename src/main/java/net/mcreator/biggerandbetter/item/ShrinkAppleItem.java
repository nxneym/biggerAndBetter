...
import net.mcreator.biggerandbetter.procedures.ShrinkEatProcedure;

public class ShrinkAppleItem extends Item {
	public ShrinkAppleItem() {
	...
	public ItemStack finishUsingItem(ItemStack itemstack, Level world, LivingEntity entity) {
		...
		ShrinkEatProcedure.execute(world, entity);
		return retval;
	}
}
